/**
 * Amazon RDS certificate authority bundle for ap-south-1.
 *
 * Embedded rather than read from disk or fetched at boot: the build compiles
 * src/ to dist/ with swc, which does not copy .pem files, and a database
 * connection that depends on a network fetch to start is a database connection
 * that fails when the network hiccups.
 *
 * Source: https://truststore.pki.rds.amazonaws.com/ap-south-1/ap-south-1-bundle.pem
 * These roots expire in 2061 and 2121; refresh if AWS rotates them.
 */
